...
import { BookOpen, Clock, Target, BarChart3, Calculator, DollarSign, GraduationCap, BookMarked, Users, Brain } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-vintage-warm-cream to-vintage-sage-green/10">
      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs defaultValue="education" className="w-full">
          ...
          {/* Duplicate education tab content removed */}
