  ...
  return (
    <section className="py-16 bg-gradient-to-b from-vintage-warm-cream to-vintage-warm-cream/30">
      <div className="container mx-auto px-4">
        ...
        {/* Dojo Philosophy */}
        <div className="bg-gradient-to-r from-vintage-sage-green to-vintage-deep-blue rounded-lg shadow-xl p-8 mb-12 text-vintage-warm-cream border-4 border-vintage-gold/30">
