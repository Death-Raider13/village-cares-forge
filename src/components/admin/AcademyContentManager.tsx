...
import { PlusCircle, Edit3, Trash2, Send, CheckCircle, AlertTriangle } from 'lucide-react';
        ...
        <TabsContent value={selectedDiscipline} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage existing academy content</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Recent notifications sent for {selectedDiscipline} content</CardDescription>
            </CardHeader>
            <CardContent>
